...
execute {cmd='echo "export RSTUDIO_MODULE_VERSION="4.3.2"; export RSTUDIO_TAG="4.3.2"; export RSTUDIO_IMAGE="geospatial"" > ~/.config_r_studio', modeA={"load"}}
...
execute {cmd="echo R_LIBS_USER=/library/R/rocker/4.3.2:$CONDA_RPACKAGES_ENV/lib/R/library >> ~/.Renviron", modeA={"load"}}

...
--
--
whatis("Name : The Rocker Project - RStudio ML")
...
execute {cmd='echo "export RSTUDIO_MODULE_VERSION="4.3.1_ml"; export RSTUDIO_TAG="4.3.1"; export RSTUDIO_IMAGE="ml-verse"" > ~/.config_r_studio', modeA={"load"}}
...
execute {cmd="echo R_LIBS_USER=/library/R/rocker/4.3.1_ml >> ~/.Renviron", modeA={"load"}}

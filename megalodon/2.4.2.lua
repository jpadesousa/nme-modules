...
prepend_path("PATH", "/cluster/work/nme/software/apps/megalodon/2.4.2/bin")
prepend_path("PYTHONPATH", "/cluster/apps/nss/gcc-6.3.0/python/3.8.5/x86_64/lib64/python3.8/site-packages:/cluster/work/nme/software/apps/megalodon/2.4.2")
